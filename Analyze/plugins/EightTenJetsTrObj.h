// -*- C++ -*-
//
// Package:    Test/EightTenJetsTrObj
// Class:      EightTenJetsTrObj
// 
/**\class EightTenJetsTrObj EightTenJetsTrObj.cc Test/EightTenJetsTrObj/plugins/EightTenJetsTrObj.cc
...
class EightTenJetsTrObj : public edm::EDAnalyzer {
   public:
      explicit EightTenJetsTrObj(const edm::ParameterSet&);
      ~EightTenJetsTrObj();
    ...
    //  edm::InputTag  _trigResultsLabel;
      ...
      //Tree variables
		...
		//FatJets
			...
			int  _fatNJet;
		//Trigger Objects
			std::vector<float> _trObjPFPt, _trObjPFEt, _trObjPFEta, _trObjPFPhi, _trObjCALOPt, _trObjCALOEt, _trObjCALOEta, _trObjCALOPhi;
			float _trObjPFHt, _trObjCALOHt;
			int _trObjPFNJet, _trObjCALONJet;
